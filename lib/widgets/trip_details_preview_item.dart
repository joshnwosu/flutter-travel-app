...
import 'package:flutter_travel_app/models/trip_data.dart';
import 'package:flutter_travel_app/widgets/trip_data_card.dart';
  ...
  final tripData = [
    ...
    const TripData(
      ...
      imagePath:
          'https://images.pexels.com/photos/2678301/pexels-photo-2678301.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      tripAdditionalInfos: [
        (title: 'Sun', number: '4B km'),
        (title: 'Moon', number: '2M km'),
      ],
    ),
  ];
          ...
          child: Column(
            ...
            children: AnimationConfiguration.toStaggeredList(
              childAnimationBuilder:
                  (child) => SlideAnimation(verticalOffset: 30, child: child),
